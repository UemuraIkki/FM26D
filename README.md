...
- 移籍ウィンドウ(夏7-8月・冬1月): 余剰リストアップ→費用対効果でターゲット選定→クラブ間交渉(自己評価×デプス係数)→選手同意(フェーズDまでスタブ)→成立
...
- **フェーズD**: 選手本人の移籍判断(出場機会・賃金・クラブ評判・野心)。`PlayerAgent` スタブを置換し、「出場機会目当ての移籍拒否」が観測されることが完了条件
- **フェーズE**: モラル(日次平均回帰、能力影響±5%制限、10シーズン非発散)
